...
export enum Occupation {
   ...
   */
  export const NUCC_CODE_MAP: Record<string, {occupation: Occupation; specialty: string}> = {
    // Physicians - Family Medicine
    "207Q00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.FAMILY_MEDICINE},
    // Physicians - Internal Medicine
    "207R00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.INTERNAL_MEDICINE},
    // Physicians - Pediatrics
    "208000000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.PEDIATRICS},
    ...
    "207RC0000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.CARDIOLOGY},
    // Physicians - Neurology
    "2084N0400X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.NEUROLOGY},
    // Physicians - Dermatology
    "207N00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.DERMATOLOGY},
    // Physicians - Endocrinology
    "207RE0101X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.ENDOCRINOLOGY},
    // Physicians - Gastroenterology
    "207RG0100X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.GASTROENTEROLOGY},
    // Physicians - Oncology
    "207RX0202X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.ONCOLOGY},
    // Physicians - Psychiatry
    "2084P0800X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.PSYCHIATRY},
    // Physicians - Gynecology
    "207VG0400X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.GYNECOLOGY},
    ...
    "207RG0300X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.GERIATRICS},
    // Physicians - Critical Care
    "207RC0200X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.CRITICAL_CARE},
    // Physicians - Hospitalist
    "208M00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.HOSPITALIST},
    // Physicians - Urology
    "208800000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.UROLOGY},
    // Physicians - Vascular Surgery
    "2086S0122X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.VASCULAR_SURGERY},
    // Physicians - Thoracic Surgery
    "208G00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.THORACIC_SURGERY},
    // Physicians - Nuclear Medicine
    "207U00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.NUCLEAR_MEDICINE},
    // Physicians - Pathology
    "207ZP0101X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.PATHOLOGY},
    // Physicians - Physical Medicine
    "208100000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.PHYSICAL_MEDICINE},
    ...
    "2085R0202X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.RADIOLOGY},
    // Physicians - General
    "207Z00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.OTHER},
    ...
    "207L00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.ANESTHESIOLOGY},
    "207RH0000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.HEMATOLOGY},
    "207RI0200X": {
      occupation: Occupation.PHYSICIAN,
      specialty: PhysicianSpecialty.INFECTIOUS_DISEASE,
    },
    "207RN0300X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.NEPHROLOGY},
    "207RP1001X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.PULMONOLOGY},
    "207RR0500X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.RHEUMATOLOGY},
    "208600000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.GENERAL_SURGERY},
    "207T00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.NEUROSURGERY},
    "207W00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.OPHTHALMOLOGY},
    "207X00000X": {
      occupation: Occupation.PHYSICIAN,
      specialty: PhysicianSpecialty.ORTHOPEDIC_SURGERY,
    },
    "207Y00000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.OTOLARYNGOLOGY},
    "208200000X": {occupation: Occupation.PHYSICIAN, specialty: PhysicianSpecialty.PLASTIC_SURGERY},
    ...
    // Registered Nurses
    "163W00000X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.GENERAL},
    "163WC0200X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.CRITICAL_CARE},
    "163WE0003X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.EMERGENCY},
    "163WM0102X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.MEDICAL_SURGICAL},
    "163WX0002X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.OBSTETRIC},
    "163WX0100X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.ONCOLOGY},
    "163WP0200X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.PEDIATRIC},
    "163WP1700X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.PERIOPERATIVE},
    "163WP0808X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.PSYCHIATRIC},
    "163WP0000X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.REHABILITATION},
    "163WX0200X": {occupation: Occupation.NURSE, specialty: NurseSpecialty.OTHER},
    ...
    // Pharmacists - General
    "183500000X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.COMMUNITY},
    // Pharmacists - Clinical
    "1835C0205X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.CRITICAL_CARE},
    // Pharmacists - Oncology
    "1835X0200X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.ONCOLOGY},
    // Pharmacists - Ambulatory Care
    "1835X0000X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.AMBULATORY_CARE},
    // Pharmacists - Geriatric
    "1835G0000X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.GERIATRIC},
    // Additional Pharmacist specialties
    "1835C0000X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.CARDIOLOGY},
    "1835E0002X": {
    ...
    "1835N0905X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.NUCLEAR},
    "1835P0018X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.PEDIATRIC},
    "1835P0200X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.PSYCHIATRIC},
    "1835H0000X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.HOSPITAL},
    "1835P1200X": {occupation: Occupation.PHARMACIST, specialty: PharmacistSpecialty.OTHER},
  
    // Dentists - General
    "1223G0001X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.GENERAL_DENTISTRY},
    // Dentists - Orthodontics
    "1223X0400X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.ORTHODONTICS},
    // Dentists - Oral Surgery
    "1223S0112X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.ORAL_SURGERY},
    // Dentists - Pediatric
    "1223P0221X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.PEDIATRIC_DENTISTRY},
    // Additional Dentist specialties
    "1223E0200X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.ENDODONTICS},
    "1223P0300X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.PERIODONTICS},
    "1223P0700X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.PROSTHODONTICS},
    "1223D0001X": {occupation: Occupation.DENTIST, specialty: DentistSpecialty.OTHER},
  
    // Researchers
    "100000000X": {occupation: Occupation.RESEARCHER, specialty: "Clinical Research"},
    "104100000X": {occupation: Occupation.RESEARCHER, specialty: "Social Science Research"},
  
    // Other - Clinical Psychologist
    "103TC0700X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.CLINICAL_PSYCHOLOGIST},
    // Other - Physical Therapist
    "225100000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.PHYSICAL_THERAPIST},
    // Other - Dietitian
    "133V00000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.DIETITIAN},
    // Other - Chiropractor
    "111N00000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.CHIROPRACTOR},
    // Other - Optometrist
    "152W00000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.OPTOMETRIST},
    // Additional Other specialties
    "224P00000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.PODIATRIST},
    "225X00000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.OCCUPATIONAL_THERAPIST},
    "227800000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.RESPIRATORY_THERAPIST},
    "235Z00000X": {
      occupation: Occupation.OTHER,
      specialty: OtherSpecialty.SPEECH_LANGUAGE_PATHOLOGIST,
    },
    "146L00000X": {occupation: Occupation.OTHER, specialty: OtherSpecialty.OTHER},
  
    // Student
    "390200000X": {occupation: Occupation.STUDENT, specialty: StudentSpecialty.MEDICAL_STUDENT},
    "390210000X": {occupation: Occupation.STUDENT, specialty: StudentSpecialty.NURSING_STUDENT},
    "390220000X": {
      occupation: Occupation.STUDENT,
      specialty: StudentSpecialty.PHYSICIAN_ASSISTANT_STUDENT,
    },
    "390230000X": {occupation: Occupation.STUDENT, specialty: StudentSpecialty.PHARMACY_STUDENT},
    "390240000X": {occupation: Occupation.STUDENT, specialty: StudentSpecialty.DENTAL_STUDENT},
    "390250000X": {occupation: Occupation.STUDENT, specialty: StudentSpecialty.RESIDENT},
    "390260000X": {occupation: Occupation.STUDENT, specialty: StudentSpecialty.FELLOW},
    "390290000X": {occupation: Occupation.STUDENT, specialty: StudentSpecialty.OTHER},
  };
   ...
   */
  export function isSpecialtyForOccupation(occupation: Occupation, specialty: string): boolean {
